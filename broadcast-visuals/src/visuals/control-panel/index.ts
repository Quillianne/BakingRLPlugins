...
const BO_SERVICE_REF = "bakingrl.stats-extended/boTracker";
const STATS_SERVICE_REF = "bakingrl.stats-extended/playerStatsTracker";
const REGIE_SERVICE_REF = "bakingrl.broadcast-visuals/regieController";
const STATE_EVENT = "plugin.bakingrl.stats-extended.series";
