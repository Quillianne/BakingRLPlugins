...
export const BO_STATE_EVENT = "plugin.bakingrl.stats-extended.series";
export const BO_STATE_KEY = "plugin.bakingrl.stats-extended.series";
export const GAME_SEQUENCE_EVENT = "plugin.bakingrl.stats-extended.sequence";
export const GAME_SEQUENCE_KEY = "plugin.bakingrl.stats-extended.sequence";
export const PLAYER_STATS_EVENT = "plugin.bakingrl.stats-extended.player-stats";
export const PLAYER_STATS_KEY = "plugin.bakingrl.stats-extended.player-stats";
export const CAGE_STATS_EVENT = "plugin.bakingrl.stats-extended.cage-stats";
export const CAGE_STATS_KEY = "plugin.bakingrl.stats-extended.cage-stats";
export const REGIE_EVENT = "plugin.bakingrl.broadcast-visuals.regie";
export const REGIE_KEY = "plugin.bakingrl.broadcast-visuals.regie";
